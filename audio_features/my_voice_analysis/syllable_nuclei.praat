...
minpause = 'minimum_pause_duration'
   ...
   Read from file... 'directory$''filename$''extension$'
...
# use object ID
  ...
  # get pauses (silences) and speakingtime
   To TextGrid (silences)... silencedb minpause 0.1 silent sounding
   ...
   #Save Text Grid
   select 'textgridid'
   Save as text file: directory$ + "/"+ filename$ +"_pauses.TextGrid"
