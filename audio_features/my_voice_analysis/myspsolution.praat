...
Save as text file: "'directory$'/'soundname$'_voice_analysis.TextGrid"
...
# clean up before next sound file is opened
	...
	Read from file... 'directory$'/'soundname$'_voice_analysis.TextGrid
...
outside= 0
for k from 2 to 'int'
	select TextGrid 'soundname$'_voice_analysis
