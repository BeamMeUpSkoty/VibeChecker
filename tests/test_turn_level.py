...
@pytest.fixtures
def turn_taking_files(tmp_path):
    """
...
def test_turn_taking_accomodation(turn_taking_files):
    wav_path, csv_path = turn_taking_files
    ...
    accomodation = TT.get_accommodation()
...
def test_turn_taking_convergence(turn_taking_files):
    wav_path, csv_path = turn_taking_files
    features = ["mean_f0"]
